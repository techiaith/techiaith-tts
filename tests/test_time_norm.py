...
tests = [
    ...
    ["20:30", "hanner awr wedi wyth y hwyr"],
    ["16:01", "un munud wedi pedwar y hwyr"],
    ["04:01 yb", "un munud wedi pedwar y bore"],
    ["5:15 yb", "chwater awr wedi pump y bore"],
    ["4:45 yh", "chwater awr i bump y hwyr"],
    ["16:22", "dau funud ar hugain wedi pedwar y hwyr"],
    ["16:34", "chwe munud ar hugain i bump y hwyr"],
