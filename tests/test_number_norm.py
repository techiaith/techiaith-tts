...
tests = [
    ...
    ["1", "un"],
    ["2", "dau"],
    ["2 glustog", "dau glustog"],
    ["2 gadair", "dwy gadair"],
    ["3", "tri"],
    ["3 chlustog", "tri chlustog"],
    ["3 cadair", "tair gadair"],
    ["4", "pedwar"],
    ["5", "pump"],
    ["6", "chwech"],
    ["7", "saith"],
    ...
    ["£9", "naw punt"],
    ["£10", "deg punt"],
    ["£1050.25", "un mil pum deg punt a dau ddeg pump ceiniog"],
